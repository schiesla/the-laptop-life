    ...
    <>
      ...
      <section className="section">
        <div className="container">
          ...
          <p className="section-sub">No fluff, no paid placements. Just honest takes on the gear that actually makes mobile work better.</p>
                ...
                <div className="product-card" key={p.id}>
                  ...
                  <div className="product-body">
                    ...
                    <div className="product-footer">
                      ...
                      <a href={p.affiliateUrl} className="btn btn-primary btn-sm" rel="noopener noreferrer">View Deal →</a>
                    </div>
                  </div>
                </div>
              ))}
