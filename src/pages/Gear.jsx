  ...
  return (
    <div>
      <SEO
        ...
        description="Hand-picked laptops, stands, chargers, keyboards, and accessories for remote workers. Tested in real cafes and co-working spaces."
        path="/gear"
      />
      ...
      <div style={{ background: 'var(--black)', color: 'var(--white)', padding: '4rem 0' }}>
        <div className="container">
          ...
          <h1 className="section-title" style={{ color: 'var(--white)' }}>The Mobile Worker's Toolkit</h1>
        ...
        <div className="container">
          ...
          {loading ? (
            <div className="grid-3">
              {[1, 2, 3, 4, 5, 6].map((n) => (
                <div key={n} className="product-card skeleton" style={{ minHeight: 320 }} />
              ))}
            </div>
          ) : (
            <div className="grid-3">
